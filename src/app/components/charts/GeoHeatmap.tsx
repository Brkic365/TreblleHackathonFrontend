    ...
    return (
      <div className={styles.geoContainer}>
        ...
        <div className={styles.emptyState}>
          ...
          <p style={{ fontSize: '0.75rem', opacity: 0.7 }}>No location data has been collected for requests</p>
        </div>
      </div>
    );
  }
                  ...
                  <div className={styles.countryInfo}>
                    <span className={styles.countryFlag}>
                      {String.fromCodePoint(
                        ...item.countryCode.toUpperCase().split('').map(char => 127397 + char.charCodeAt(0))
                      )}
                    </span>
